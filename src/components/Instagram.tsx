...
const Instagram = () => {
  return (
    <div className="max-w-[1440px] flex flex-col md:h-screen items-center justify-center mx-auto text-center pb-2 md:pb-8 lg:pb-16 pt-12 lg:mt-32 px-2 text-gray-300">
